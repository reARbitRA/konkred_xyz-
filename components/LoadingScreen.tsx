...
const LoadingScreen: React.FC<LoadingScreenProps> = ({ onComplete }) => {
  ...
  useEffect(() => {
    ...
    const lines = ['SEATING RIVETS', 'LOADING ENTRIES', 'CHECKING ROUTES', 'OPENING PORTFOLIO'];
    let line = 0;
  ...
  return <div className="boot-screen chalk-smudge">
    ...
    <div className="boot-content">
      ...
      <p className="machine-label boot-foot">21 SUITES / 15 WORKFLOWS / HUMAN-OWNED OUTPUTS</p>
    </div>
  </div>;
};
